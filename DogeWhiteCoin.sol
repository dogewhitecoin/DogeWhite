...
//
// Copyright of The $DogeWhite Team

// There is a pot of gold at the end of every DogeWhite
// 
// $DogeWhite has 7% tax split across 7 protocols
...
/**
 * @dev The official DogeWhiteCoin smart contract
 */
contract DogeWhiteCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "DogeWhiteCoin";
    string private _symbol   = "DogeWhite";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for DogeWhite/WBNB
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $DogeWhite will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-DogeWhite tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts DogeWhite balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns DogeWhite tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of DogeWhite tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from DogeWhite)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of DogeWhite
            path,
